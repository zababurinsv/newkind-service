(function() {
    ...
    function F() {
        ...
        if (d) try {
            ...
            console.warn("PWACompat error", r1);
        }
        else {
    ...
    function G(a, b) {
        function d(f, c, h, m) {
            var e = window.devicePixelRatio, l = D({
                width: f * e,
                height: c * e
            });
            l.scale(e, e);
            ...
            else for(e = e.split(/\s+/g), c = 1; c <= e.length; ++c){
                var H = e.slice(0, c).join(" "), I = l.measureText(H).width;
        ...
        function n(f, c) {
            var h = window.screen, m = d(h.width, h.height, "portrait", f), e = d(h.height, h.width, "landscape", f);
            setTimeout(function() {
                u.p = m();
                setTimeout(function() {
                    u.l = e();
        ...
        var T = !!(p && p.content || "").match(/\bviewport-fit\s*=\s*cover\b/), M = a.display;
        p = -1 !== U.indexOf(M);
        ...
        if (A) {
            var y = a.background_color || "#f8f9fa", S = N(y);
    ...
    function D(a) {
        ...
        var b = a.height, d = document.createElement("canvas");
        d.width = a.width;
        d.height = b;
    ...
    if ("onload" in XMLHttpRequest.prototype && !navigator.m) {
        var U = [
            ...
            "fullscreen",
            "minimal-ui"
        ], P = navigator.userAgent || "", A = navigator.vendor && -1 !== navigator.vendor.indexOf("Apple") && (-1 !== P.indexOf("Mobile/") || "standalone" in navigator) || !1, W = !!P.match(/(MSIE |Edge\/|Trident\/)/), Y = "undefined" !== typeof Windows, x;
        try {
...
//# sourceMappingURL=index.ac145a51.js.map
