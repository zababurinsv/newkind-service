...
})({"8bTUJ":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "1293bae57ac04db4";
module.bundle.HMR_BUNDLE_ID = "0ed66575da3f5367";
"use strict";
...
},{}],"7uTQD":[function(require,module,exports) {
...
self.addEventListener("message", async (event)=>{
    if (event.data.activate) {
        CONFIG.memory = _comlink.wrap(event.data.worker);
        event.source.postMessage({
            service: "activate"
        });
    }
    if (event.data.test) CONFIG.memory.fs.list.dir();
});
...
},{"comlink":"cL1pH"}],"cL1pH":[function(require,module,exports) {
...
},{}]},["8bTUJ","7uTQD"], "7uTQD", "parcelRequirec3cc")
