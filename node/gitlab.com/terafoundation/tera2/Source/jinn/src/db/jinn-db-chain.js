...
class CDBChain
{
    constructor(EngineID, FCalcBlockHash, Prefix)
    {
        if(!Prefix)
            Prefix = ""
        ...
        this.DBMainIndex = new CDBRow(Prefix + "main-index", {MainPosition:"uint"}, !BWRITE_MODE, "BlockNum", 10, 0, EngineID)
        this.DBChainIndex = new CDBRow(Prefix + "chain-index", {LastPosition:"uint"}, !BWRITE_MODE, "BlockNum", 10, 0, EngineID)
        this.DBBlockHeader = new CDBItem(Prefix + "block-data", DB_HEADER_FORMAT, !BWRITE_MODE, EngineID, 1)
        this.DBBlockBody = new CDBItem(Prefix + "block-data", BODY_FORMAT, !BWRITE_MODE, EngineID)
